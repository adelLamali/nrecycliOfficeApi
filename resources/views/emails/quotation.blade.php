...
| <img src="https://office.nrecycli.com/pics/threeStreams.webp" style="border-radius:100%" width="30" height="30" alt="nrecycli"> | {{__('office.cardboardbinpet')}}   |1.850 {{__('office.da')}}| x {{$quotation['order']['cardboardBinPet']}} | {{ $quotation['order']['cardboardBinPet'] * 1850 }} {{__('office.da')}} |
| <img src="https://office.nrecycli.com/pics/threeStreams.webp" style="border-radius:100%" width="30" height="30" alt="nrecycli"> | {{__('office.cardboardbinrp')}}   |1.850 {{__('office.da')}}| x {{$quotation['order']['cardboardBinRp']}} | {{ $quotation['order']['cardboardBinRp'] * 1850 }} {{__('office.da')}} |
| <img src="https://office.nrecycli.com/pics/threeStreams.webp" style="border-radius:100%" width="30" height="30" alt="nrecycli"> | {{__('office.cardboardbinpaper')}}   |1.850 {{__('office.da')}}| x {{$quotation['order']['cardboardBinAluminium']}} | {{ $quotation['order']['cardboardBinAluminium'] * 1850 }} {{__('office.da')}} |
| <img src="https://office.nrecycli.com/pics/threeStreams.webp" style="border-radius:100%" width="30" height="30" alt="nrecycli"> | {{__('office.cardboardbinaluminium')}}   |1.850 {{__('office.da')}}| x {{$quotation['order']['cardboardBinPaper']}} | {{ $quotation['order']['cardboardBinPaper'] * 1850 }} {{__('office.da')}} |
